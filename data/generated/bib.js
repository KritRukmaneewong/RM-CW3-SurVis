const generatedBibEntries = {
   "VPN01": {
    ...
    "keywords": "VPN, security assessment, type:survey, evaluation, vulnerabilities, survey",
    "series": "ACM CSUR",
  ...
  "VPN03": {
    ...
    "keywords": "VPN, Traffic Obfuscation, Anti-Detection, type:article",
    "series": "CACM",
  ...
  "VPN10": {
    ...
    "keywords": "VPN perception, VPN marketing, Privacy, Risk, provider transparency, user trust, type:conference",
    "series": "ACM WPES",
  ...
  "VPN07": {
    ...
    "keywords": "Virtual Private Network, Fuzzing, iOS, Linux, type:conference",
    "series": "IEEE CNS",
  ...
  "VPN02": {
    ...
    "keywords": "VPN, IPsec, NIST, guidelines, security standard, type:techreport",
    "series": "NIST",
  ...
  "VPN08": {
    ...
    "keywords": "VPN geo-unblocking, content restriction, residential proxy, circumvention, streaming access, VPN evasion, type:conference",
    "series": "LNCS",
  ...
  "VPN05": {
    ...
    "keywords": "VPN, network security, analysis, type:conference",
    "series": "ICISS",
  ...
  "VPN04": {
    ...
    "keywords": "VPN, commercial services, privacy, logging policy, transparency, type:conference",
    "series": "IMC",
  ...
  "VPN09": {
    ...
    "keywords": "VPN, Android, client-side vulnerability, mobile security, app analysis, type:conference",
    "series": "LNCS",
  ...
  "VPN06": {
    ...
    "keywords": "VPN security, DoS attacks, adversarial testing, VPN protocol, WireGuard, OpenVPN, network availability, type:conference",
    "series": "NDSS",
